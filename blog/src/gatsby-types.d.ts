...
type BioQueryQuery = { readonly site: { readonly siteMetadata: { readonly author: { readonly name: string | null, readonly summary: string | null } | null, readonly social: { readonly twitter: string | null } | null } } | null };
...
type BlogPostBySlugQuery = { readonly site: { readonly siteMetadata: { readonly title: string | null } } | null, readonly markdownRemark: { readonly id: string, readonly excerpt: string | null, readonly html: string | null, readonly frontmatter: { readonly title: string | null, readonly date: string | null, readonly description: string | null } } | null, readonly previous: { readonly fields: { readonly slug: string }, readonly frontmatter: { readonly title: string | null, readonly lang: string | null } } | null, readonly next: { readonly fields: { readonly slug: string }, readonly frontmatter: { readonly title: string | null, readonly lang: string | null } } | null };
...
type AllMarkdownQueryVariables = Exact<{ [key: string]: never; }>;


type AllMarkdownQuery = { readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly id: string, readonly fields: { readonly slug: string }, readonly frontmatter: { readonly lang: string | null } }> } };
